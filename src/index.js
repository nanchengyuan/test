...
// class LogginButton extends React.Componet {
...
//     // 此语法确保 `handleClick` 内的 `this` 已被绑定。
//     return (
//       <button onClic={() => this.handleClick()}>
//         Click me
//       </button>
//     );
//   }
...
class Pos extends React.Component {
  constructor(props) {
    ...
    // this.state = {jieguoArray: true};
    // this.handleClick = this.handleClick(this);
  };
  // handleClick() {
  //   this.setState(prevState => ({
  //     jieguoArray: !prevState.jieguoArray
  //   }));
  // }
  render() {
    return (
